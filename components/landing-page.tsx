      ...
      <main className="px-4 py-12">
        ...
        <section className="mt-16 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {startups.map((startup, index) => {
            ...
            return (
              <div key={index} className="rounded-lg overflow-hidden transition-all duration-300 ease-in-out hover:scale-105 hover:shadow-lg bg-white border border-gray-200 hover:bg-gray-50">
                <div className="p-6">
